...
<section class="home-banner">
  <div class="container">
    <div class="home-banner-txt">
      ...
      <span>A Emtel é uma empresa que caminha na direção da inovação e do constante desenvolvimento, com competência e
        qualidade.</span>
  ...
  <div class="container">
    ...
    <div class="home-group-item">
      <div class="home-group-txt">
        ...
        <p>A Emtel Seminovos surgiu com o objetivo de revolucionar o conceito de comercialização de veículos, visando a
    ...
    <div class="home-group-item">
      <div class="home-group-txt">
        ...
        <p>Com objetivo de garantir excelência em todos os seus processos, a Triasa conta um amplo espaço e apresenta um
    ...
    <div class="home-group-item">
      <div class="home-group-txt">
        ...
        <p>A modalidade Emtel carros para APP é destinada ao aluguel de carros para motoristas que trabalham por meio de
          aplicativos.</p>
  ...
  <div class="container">
    <div class="home-about-txt">
      ...
      <p>Com um jeito simples e cordial, a Emtel Logística enraizou uma cultura de respeito mútuo entre gestores e
        ...
        encara os desafios e entrega os resultados. Confie em quem sabe o que faz!</br>
